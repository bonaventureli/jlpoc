...
void BllCANPeriodTask(void)    		// CAN Period Task
{
	...
	//FlagReception = BspCANReceiveA(&gsRxCANData.StdID,&gsRxCANData.Data[0],&gsRxCANData.DataLen); 
...
{
	gsCarStatus.MainCarWindow = BllGetValueCan(RxData,STATUS_PILOT_WINDOW);
}
...
{
	gsCarStatus.SubCarWindow = BllGetValueCan(RxData,STATUS_PSSENGER_WINDOW);
}
...
{
	gsCarStatus.LeftBackWindow = BllGetValueCan(RxData,STATUS_LEFTBACK_WINDOW);
}
...
{
	gsCarStatus.RightBackWindow = BllGetValueCan(RxData,STATUS_RIGHTBACK_WINDOW);
}
...
{
	gsCarStatus.StatusSkyLight = BllGetValueCan(RxData,STATUS_SKYLIGHT_WINDOW);
}
...
** Return:      None
******************************************************************************/
void MslGetFanStatus(T_CANDATA *RxData)
{
	gsCarStatus.StatusBlower = BllGetValueCan(RxData,STATUS_FAN);
}
